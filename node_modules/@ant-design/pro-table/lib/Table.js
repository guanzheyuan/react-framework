...
function TableRender(props) {
  var _props$columns, _props$editable;
  ...
  var tableLayout = ((_props$columns = props.columns) === null || _props$columns === void 0 ? void 0 : _props$columns.some(function (item) {
    return item.ellipsis;
  })) ? 'fixed' : 'auto';
  /** 默认的 table dom，如果是编辑模式，外面还要包个 form */

  var baseTableDom = /*#__PURE__*/_react.default.createElement(_form.default, {
    component: false,
